...
Object.defineProperties( module.exports, {
  initialize: {
    ...
    value: function initialize( done ) {
      ...
      //console.log( require( 'util').inspect( this.config, { colors: true , depth:5, showHidden: false } ) );

      // console.log( 'asdf', typeof this.modelSchema );

      // this.config.collection = this.modelSchema;
