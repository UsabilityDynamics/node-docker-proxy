...
function beforeValidate( data, done ) {
  ...
  var _hostname = [];
  var _dockerHostname = process.env.DOCKER_HOSTNAME || process.env.DOCKER_ADDRESS || ( process.env.DOCKER_HOST ? process.env.DOCKER_HOST.split( ':' )[0] : 'localhost' );
