...
function dockerProxy( handler, module ) {
  ...
  } catch( error ) { console.error( 'Veneer Proxy Service spawn failure. Message: [%s]', error.message, error ); }

}

/**
 * veneerService Instance Properties.
 *
 */
Object.defineProperties( dockerProxy.prototype, {
  ...
  Session: {
    value: function( options ) {
      this.use( require( 'veneer-service' ).prototype.middleware.Session.create( options ) );
    },
    enumerable: true,
    configurable: true,
    writable: true
  ...
  Validate: {
    value: function( options ) {
      this.use( require( 'veneer-service' ).prototype.middleware.Validate.create( options ) );
    },
    enumerable: true,
    configurable: true,
    writable: true
