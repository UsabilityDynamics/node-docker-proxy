...
function dockerProxy( handler, serviceModule ) {
  ...
  this.settings.set({
    ...
    currentModule: serviceModule ? serviceModule : null,
    docker: {
      host: process.env.DOCKER_HOST || 'localhost',
      sock: process.env.DOCKER_SOCK_PATH || '/var/run/docker.sock',
  ...
  // Extend Settings events into global broker.
  deepExtend( this._events.settings, this.settings._events );
